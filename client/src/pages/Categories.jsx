        ...
        <Row className="mt-5 mr-5 ml-5 justify-content-md-center ">
          <Col xs={12} md={6}>
            ...
            <div className="josefin-sans-300 mt-4 mb-4">
              Jobs are posted according to categories. Check out the categories
              below and search for a specific job field.
            </div>
          </Col>
        </Row>
        <Row
          ...
          // md={2}
          // lg={4}
          className="mr-5 ml-5 justify-content-md-center "
        >
          {types.map((type, i) => (
            <Col key={i} md={3} className="josefin-sans-300 mt-4 mb-4">
              <Card>
                <Card.Body>
                  <Image
                    fluid
